      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                // The route name is admin-authored and can be long, so the
                // title block takes the leftover width and ellipsizes rather
                // than pushing the zone chip off the card.
                Expanded(
                  child: Row(
                    children: [
                      Container(
